...
export function extractRequestedFeatures(text: string) {
...
export function extractStylePreferences(text: string) {
  const styleKeywords = {
...
export function parseOpenAIResponse(data: any): AIServiceResponse {
  try {
...
export function parseHuggingFaceResponse(data: any): AIServiceResponse {
  try {
